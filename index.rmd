...
###Executive Summary
The goal of this analysis is to develop an algorithm which can correctly predict the manner in which a person performed an exercise. To do this, the analysis relis upon two data sets provided by:
